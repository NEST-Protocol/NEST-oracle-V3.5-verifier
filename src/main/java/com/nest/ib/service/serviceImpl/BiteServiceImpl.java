...
import com.nest.ib.contract.PriceSheetPub2;
...
public class BiteServiceImpl implements BiteService {
    ...
    private static final String BITE_ETH = "biteEth";
    private static final String BITE_TOKEN = "biteToken";
    ...
    public void bite(Wallet wallet) {
        ...
        List<PriceSheetPub2> tokenSheetPubList = null;
        List<PriceSheetPub2> nTokenSheetPubList = null;
    ...
    private boolean bite(Wallet wallet,
                         BigInteger nonce,
                         List<PriceSheetPub2> sheetPubList,
                         BigInteger nowBlockNumber,
                         Erc20State.Item erc20,
                         BigDecimal biteRate) {
        boolean bite = false;
        for (PriceSheetPub2 priceSheetPub : sheetPubList) {
            ...
            BigDecimal orderPrice = MathUtils.intDivDec(priceSheetPub.tokenAmountPerEth, erc20.getDecPowTen(), erc20.getDecimals());
            ...
            BigInteger dealErc20Amount = dealEthAmount.multiply(priceSheetPub.tokenAmountPerEth);
            ...
            if (canEatAll) {
                ...
                biteFee = biteOneFee;
                copies = getCopies(useable, biteEth, erc20, orderPrice, ethMultiple, biteOneFee, priceSheetPub.nestNum1k, priceSheetPub.ethNum);
    ...
    private String sendBiteOffer(PriceSheetPub2 priceSheetPub,
                                 Erc20State.Item erc20,
                                 BigInteger multiple,
                                 boolean eatEth,
                                 BigInteger copies,
        ...
        BigInteger newNestNum1k = priceSheetPub.nestNum1k.multiply(nestProperties.getBiteNestInflateFactor().multiply(biteNum)).divide(priceSheetPub.ethNum);
        ...
        BigInteger tranErc20Amount = priceSheetPub.tokenAmountPerEth.multiply(biteNum);
    ...
    private String closePriceSheetList(Wallet wallet, BigInteger nonce, Erc20State.Item erc20) {
        ...
        List<Uint32> indices = ethClient.canClosedSheetIndexs(wallet.getCredentials().getAddress(), erc20.getAddress(), verifyState.getMaxFindNum());
